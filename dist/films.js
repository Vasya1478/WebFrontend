...
var film = {
    ...
    getGenre: function getGenre() {
        var genreFilm = this.genre;
        var arrGenres = [];

        for (var _i = 0; _i < genreFilm.length; _i++) {
            arrGenres.push(genres[genreFilm[_i]]);
        }

        var strGenres = arrGenres.join(', ');
        return strGenres;
    },

    getLink: function getLink() {
        var linkFilm = this.link;
        var arrLink = [];

        for (var _i2 = 0; _i2 < linkFilm.length; _i2++) {
            arrLink.push(links[linkFilm[_i2]]);
        }

        var strLinks = arrLink.join(' ');
        return strLinks;
    },
...
var orderFormWindow = document.getElementById('orderForm');
...
var _loop = function _loop(_i3) {
    ...
    var filmName = film.getName.apply(filmsHires[_i3]);
    var filmStart = film.getStart.apply(filmsHires[_i3]);
    var filmGenre = film.getGenre.apply(filmsHires[_i3]);
    var filmPrice = film.getPrice.apply(filmsHires[_i3]);
    var filmsHir = document.getElementById('filmsHir');

    // console.log()

    var filmHTML = '<td id="start_film_' + _i3 + '">' + filmStart + '</td>\n    <td id="name_film_' + _i3 + '">' + filmName + '</td>\n    <td id="genre_film_' + _i3 + '">' + filmGenre + '</td>\n    <td>' + filmPrice + '</td>';
    ...
    tr.onclick = function () {
        ...
        var orderFilmName = document.getElementById('orderFilmName');
        var orderFilmStart = document.getElementById('orderFilmStart');
        var orderFilmGenre = document.getElementById('orderFilmGenre');
        var orderFilmPrice = document.getElementById('orderFilmPrice');
        ...
        var orderFilmTotal = document.getElementById('orderFilmTotal');
        var orderFilmTickets = document.getElementById('orderFilmTickets');
...
for (var _i3 = 0; _i3 < filmsHires.length; _i3++) {
    _loop(_i3);
}

var sendOrder = document.getElementById('sendOrder');
var orderFilmPhone = document.getElementById('orderFilmPhone');
...
for (var _i4 = 0, j = 0; _i4 < filmsNew.length; _i4++) {
    var _filmName = film.getName.apply(filmsNew[_i4]);
    var filmImage = film.getImage.apply(filmsNew[_i4]);
    var filmLink = film.getLink.apply(filmsHires[_i4]);

    var owl_carousel = document.getElementById('owl');

    var filmNewHtml = '\n    <div class="fd-inner">\n        <div class="fd-poster"><img class="" src=' + filmImage + ' alt=' + _filmName + ' /></div>\n        <div class="fd-description">\n            <p class="fd-text1">' + _filmName + '</p>\n            <hr class="fd-hr">\n            <p class="fd-text2">\n                Lorem ipsum dolor sit amet, consectetur\n            </p>\n\n            <div id="lin" class="fd-links">\n            ' + filmLink + '\n            </div>\n        </div>\n    </div>';
